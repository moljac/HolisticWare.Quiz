...
using WebApplication.v5.WebApplication.Models;

namespace WebApplication.v5.WebApplication.Migrations
{
    ...
    partial class CreateIdentitySchema
    {
        ...
        public override void BuildTargetModel(ModelBuilder builder)
        {
            ...
            builder.Entity("WebApplication.v5.WebApplication.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .GenerateValueOnAdd()
                        .Annotation("OriginalValueIndex", 0);
            ...
            builder.Entity("Microsoft.AspNet.Identity.EntityFramework.IdentityUserClaim<string>", b =>
                {
                    b.Reference("WebApplication.v5.WebApplication.Models.ApplicationUser")
                        .InverseCollection()
                        .ForeignKey("UserId");
                });
